...
##set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clk_switch_IBUF]
...
set_property PACKAGE_PIN U9 [get_ports {Am_0am_6am}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Am_0am_6am}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports {clk_switch}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {clk_switch}]
...
set_property PACKAGE_PIN P3 [get_ports {ns_car}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ns_car}]
#Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {ew_car}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ew_car}]
...
set_property PACKAGE_PIN T8 [get_ports {lights_ew[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights_ew[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {lights_ew[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights_ew[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {lights_ew[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights_ew[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports {lights_ew[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights_ew[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
set_property PACKAGE_PIN T5 [get_ports {lights_ew[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights_ew[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
set_property PACKAGE_PIN T4 [get_ports {lights_ew[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights_ew[5]}]

    #Bank = 34, Pin name = IO_L22P_T3_34,                        Sch name = LED6
    set_property PACKAGE_PIN U7 [get_ports {lights_ns[0]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {lights_ns[0]}]
    #Bank = 34, Pin name = IO_L22N_T3_34,                        Sch name = LED7
    set_property PACKAGE_PIN U6 [get_ports {lights_ns[1]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {lights_ns[1]}]
    #Bank = 34, Pin name = IO_L10N_T1_34,                        Sch name = LED8
    set_property PACKAGE_PIN V4 [get_ports {lights_ns[2]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {lights_ns[2]}]
    #Bank = 34, Pin name = IO_L8N_T1_34,                        Sch name = LED9
    set_property PACKAGE_PIN U3 [get_ports {lights_ns[3]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {lights_ns[3]}]
    #Bank = 34, Pin name = IO_L7N_T1_34,                        Sch name = LED10
    set_property PACKAGE_PIN V1 [get_ports {lights_ns[4]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {lights_ns[4]}]
    #Bank = 34, Pin name = IO_L17P_T2_34,                        Sch name = LED11
    set_property PACKAGE_PIN R1 [get_ports {lights_ns[5]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {lights_ns[5]}]
...
#set_property PACKAGE_PIN F15 [get_ports ns_car]						
#	set_property IOSTANDARD LVCMOS33 [get_ports ns_car]
###Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports ew_car]						
#	set_property IOSTANDARD LVCMOS33 [get_ports ew_car]
