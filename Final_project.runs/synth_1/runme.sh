...
HD_PWD='H:/EECS443/Final_project/Final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stop_light.tcl
