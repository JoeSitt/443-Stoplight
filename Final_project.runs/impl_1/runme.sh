...
HD_PWD='H:/EECS443/Final_project/Final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stop_light.tcl -notrace
